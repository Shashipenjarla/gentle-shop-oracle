      ...
      <div className="container mx-auto px-4">
        ...
        <nav className="py-3 border-t border-primary-foreground/20">
          <div className="flex space-x-8 overflow-x-auto">
            ...
            <a href="/store-locator" className="whitespace-nowrap hover:underline font-medium">Store Locator</a>
            <a href="/green-rewards" className="whitespace-nowrap hover:underline font-medium">Green Rewards</a>
